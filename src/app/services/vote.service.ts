...
export class VoteService {
  ...
  create = credentials => this.http.post(this.globals.url + 'votes', credentials, this.httpOptions)
    .pipe(
      take(1),
  ...
  mine = () => this.http.post(this.globals.url + 'votes/mine', {})
    .pipe(
      take(1),
      tap(_ => this.utils.log(this.logName)),
      catchError(this.utils.handleError(this.logName, []))
